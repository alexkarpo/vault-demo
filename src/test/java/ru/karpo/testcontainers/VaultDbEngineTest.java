...
//    private int port;
    ...
    private static void logExecResult(Container.ExecResult execResult) {
        if (execResult.getExitCode() == 0) {
            logger.debug("Command execution: {}", execResult.getStdout());
        } else {
            logger.debug("Command error execution: {}, {}", execResult.getStderr(), execResult.getStdout());
        }
    }
